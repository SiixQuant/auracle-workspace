    ...
    >
      ...
      >
        ...
        <div className="px-8 pt-10 pb-8 text-center">
          <img src={logoSrc} alt="Auracle" className="mx-auto mb-5 h-12 w-auto object-contain" />
