  ...
  return (
    <div className="provider-panel flex flex-col">
      ...
      <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
        ...
        <p className="text-sm leading-relaxed text-[var(--nim-text-muted)] mb-4">
          Choose which release stream Auracle pulls auto-updates from. Alpha and beta features are configured separately on each feature&apos;s settings page.
        </p>
      ...
      <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
        ...
        <SettingsToggle
          ...
          description="Help improve Auracle by sending anonymous usage data. No prompts or personal info collected."
        />
