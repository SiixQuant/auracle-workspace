    ...
    <div className="provider-panel flex flex-col">
      <div className="provider-panel-header mb-6 pb-4 border-b border-[var(--nim-border)]">
        ...
        <p className="provider-panel-description text-sm leading-relaxed text-[var(--nim-text-muted)]">
          Agent mode uses the Claude Code SDK with a few extensions for added functionality in Auracle.
          ...
          { isWindowsPlatform ? (
            <>
              ...
              <p className="text-xs text-[var(--nim-text-muted)] mt-3 leading-relaxed">
                Auracle requires Claude Code for Windows to be installed to use the Claude Code provider.
              </p>
            ...
            <>
              ...
              <div className="installation-status p-4 rounded-lg bg-[rgba(16,185,129,0.05)] border border-[rgba(16,185,129,0.2)]">
                ...
                <p className="text-xs leading-relaxed text-[var(--nim-text-muted)] mt-3">
                  Auracle includes the Claude Agent SDK. No additional installation required.
                </p>
              </div>
            </>
          )}
