      ...
      {config.enabled && (
        <>
          ...
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)]">
            ...
            <p className="text-[13px] text-[var(--nim-text-muted)] mb-3 leading-relaxed">
              Point at a running LM Studio server and Auracle will query <code className="text-[var(--nim-code-text)] bg-[var(--nim-code-bg)] px-1 rounded">/v1/models</code>,
              ...
              You don't need to enable LM Studio as a separate Auracle chat provider.
            </p>
          ...
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
            ...
            <p className="text-[13px] text-[var(--nim-text-muted)] mb-3 leading-relaxed">
              ...
              Setting a key here is optional and is only used by Auracle's connection test.
            </p>
