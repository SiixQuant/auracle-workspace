    ...
    return (
      ...
      >
        ...
        <div className="update-toast-actions flex gap-2 flex-wrap">
          <button
            className="update-toast-btn update-toast-btn-primary py-2 px-3.5 border-none rounded-md text-[13px] font-medium cursor-pointer transition-all duration-200 font-[inherit] whitespace-nowrap bg-[var(--nim-primary)] text-[var(--nim-on-primary)] hover:brightness-110"
