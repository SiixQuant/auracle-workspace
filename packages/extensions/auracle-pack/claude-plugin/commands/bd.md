...
If I already named a source in $ARGUMENTS (for example `/bd alpaca`), skip the questions and connect that one directly, still using the masked field for any key.
