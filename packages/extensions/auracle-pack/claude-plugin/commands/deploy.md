...
4. **Pre-market check** — a one-shot readiness check: broker connectivity, net liquidation value, current positions, open orders, and the last 24h of job outcomes. Put any failures at the top.
